                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pr-8 p-2.5 bg-slate-50 border-2 border-slate-200 rounded-xl text-xs sm:text-sm text-slate-900 font-extrabold focus:border-blue-600 focus:outline-none"
                    />
